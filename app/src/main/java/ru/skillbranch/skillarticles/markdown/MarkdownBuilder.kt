...
//    private val linkIcon = context.getDrawable(R.drawable.ic_link_black_24dp)!!
    private val linkIcon = context.getDrawable(R.drawable.ic_title_black_24dp)!!
        ...
        return builder.apply {
            when(element) {
                ...
                is Element.BlockCode -> {
                    inSpans(BlockCodeSpan(colorPrimary, colorSecondary, cornerRadius, gap, element.type)) {
                        append(element.text)
                    }
                }
